...
function watch() {
    ...
    btnDisabled(btn); // disable the stop button since the game has no started
}
...
//---------------------------------------------------------------
// initiate the game, roll for turn & determine the actie player
//---------------------------------------------------------------
function startGame(){
    var xTurn = 0;
    ...
    var btn = document.getElementById('btnStop');
    stopEnabled(btn); // enable the stop button since teh game is now afoot
